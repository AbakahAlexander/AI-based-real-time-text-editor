...
public class SpeechRecognitionUtil {
    ...
    public SpeechRecognitionUtil(JTextPane textArea) {
        this.textArea = textArea;
    }
    
    public SpeechRecognitionUtil(JTextPane textArea, JLabel statusLabel) {
        this.textArea = textArea;
                    ...
                    if (!transcript.isEmpty()) {
                        SwingUtilities.invokeLater(() -> {
                            ...
                            try {
                                ...
                                logger.log(Level.WARNING, "Error inserting recognized text", e);
                            }
                        });
                    }
                }
